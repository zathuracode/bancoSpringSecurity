...
public class Usuarios  implements java.io.Serializable {
    ...
    public Usuarios(Long usuCedula, TiposUsuarios tiposUsuarios, String usuNombre, String usuLogin, String usuClave, Set<Consignaciones> consignacioneses, Set<Retiros> retiroses) {
       this.usuCedula = usuCedula;

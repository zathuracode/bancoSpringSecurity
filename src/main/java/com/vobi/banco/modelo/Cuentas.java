...
public class Cuentas  implements java.io.Serializable {
    ...
    public Cuentas(String cueNumero, Clientes clientes, Double cueSaldo, String cueActiva, String cueClave) {
    ...
    public Cuentas(String cueNumero, Clientes clientes, Double cueSaldo, String cueActiva, String cueClave, Set<Consignaciones> consignacioneses, Set<Retiros> retiroses) {
       this.cueNumero = cueNumero;
       this.clientes = clientes;
       this.cueSaldo = cueSaldo;
       this.cueActiva = cueActiva;

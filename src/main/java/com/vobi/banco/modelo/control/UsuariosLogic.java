...
public class UsuariosLogic implements IUsuariosLogic {
    ...
    */
    ...
    /**
    * Logic injected by Spring that manages TiposUsuarios entities
    *
    */
    @Autowired
    ITiposUsuariosLogic logicTiposUsuarios1;
	...
	public Usuarios validarUsuario(String usuLogin, String usuClave) throws Exception {
		Usuarios usuarios=usuariosDAO.consultarUsuarioPorUsuLogin(usuLogin);
		if(usuarios==null){
			throw new Exception(MENSAJE);
		}
		if(usuarios.getUsuClave().equals(usuClave)==false){
			throw new Exception(MENSAJE);
		}
		usuarios.getTiposUsuarios().getTusuNombre();
		return usuarios;
	}
    ...
    public void saveUsuarios(Usuarios entity) throws Exception {
        ...
        try {
            if (entity.getTiposUsuarios() == null) {
                throw new ZMessManager().new ForeignException("tiposUsuarios");
            }
            ...
            if ((entity.getUsuCedula() != null) &&
                    (Utilities.checkNumberAndCheckWithPrecisionAndScale("" +
                        entity.getUsuCedula(), 10, 0) == false)) {
            ...
            if ((entity.getUsuNombre() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getUsuNombre(), 50) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "usuNombre");
            }

            if (entity.getTiposUsuarios().getTusuCodigo() == null) {
                throw new ZMessManager().new EmptyFieldException(
                    "tusuCodigo_TiposUsuarios");
            }

            if ((entity.getTiposUsuarios().getTusuCodigo() != null) &&
                    (Utilities.checkNumberAndCheckWithPrecisionAndScale("" +
                        entity.getTiposUsuarios().getTusuCodigo(), 10, 0) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "tusuCodigo_TiposUsuarios");
            }
    ...
    public void deleteUsuarios(Usuarios entity) throws Exception {
        ...
        try {
            consignacioneses = consignacionesDAO.findByProperty("usuarios.usuCedula",
                    entity.getUsuCedula());
            ...
            retiroses = retirosDAO.findByProperty("usuarios.usuCedula",
                    entity.getUsuCedula());
    ...
    public List<UsuariosDTO> getDataUsuarios() throws Exception {
        try {
            ...
            for (Usuarios usuariosTmp : usuarios) {
                ...
                usuariosDTO2.setUsuCedula(usuariosTmp.getUsuCedula());
                usuariosDTO2.setUsuClave((usuariosTmp.getUsuClave() != null)
                    ? usuariosTmp.getUsuClave() : null);
                usuariosDTO2.setUsuLogin((usuariosTmp.getUsuLogin() != null)
                    ? usuariosTmp.getUsuLogin() : null);
                usuariosDTO2.setUsuNombre((usuariosTmp.getUsuNombre() != null)
                    ? usuariosTmp.getUsuNombre() : null);
                usuariosDTO2.setTusuCodigo_TiposUsuarios((usuariosTmp.getTiposUsuarios()
                                                                     .getTusuCodigo() != null)
                    ? usuariosTmp.getTiposUsuarios().getTusuCodigo() : null);
